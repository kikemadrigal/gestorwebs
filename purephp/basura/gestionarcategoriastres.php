	...
	function recorrerCategorias($nivelCategoria, $categoriaeshijade){
		...
		while ($linea1 = mysqli_fetch_array($resultado1)) 
		{
			...
			if($numeroDeHijosQuetieneHijosEstaCategoria==0){
				if($linea1['redireccionaidcategoria']!=0) echo "<li>".$espacios."|__ <a href=categoria/$linea1[redireccionaidcategoria]>".$linea1['nombrecategoria']."</a></li>";
				else echo "<li>".$espacios."|__ <a href=categoria/$linea1[idcategoria]>".$linea1['nombrecategoria']."</a></li>";
			}
			else{
				if($linea1['redireccionaidcategoria']!=0) echo "<li>".$espacios."|__ <a href=categoria/$linea1[redireccionaidcategoria] > <a href=categoria/$linea1[idcategoria]>".$linea1['nombrecategoria']."</a><img src='http://www.gestorwebs.tipolisto.es/imagenes/mas.png' onclick='mostrarOOcultar($linea1[idcategoria]);cambiarImagen(this);'></img>".$numeroDeHijosQuetieneHijosEstaCategoria."</li>";
				else echo "<li>".$espacios."|__ <a href=categoria/$linea1[idcategoria] > <a href=categoria/$linea1[idcategoria]>".$linea1['nombrecategoria']."</a><img src='http://www.gestorwebs.tipolisto.es/imagenes/mas.png' onclick='mostrarOOcultar($linea1[idcategoria]);cambiarImagen(this);'></img>".$numeroDeHijosQuetieneHijosEstaCategoria."</li>";
			...
			echo "<ul style='list-style:none'>";
					while ($linea = mysqli_fetch_array($resultado)) 
					{
							...
							if($numeroDeHijosQuetieneHijosEstaCategoria==0){
								...
								if($linea['redireccionaidcategoria']!=0) echo "<li>|__ <a href=categoria/$linea[redireccionaidcategoria]>".$linea['nombrecategoria']."</a><img src='http://www.gestorwebs.tipolisto.es/imagenes/mas.png' onclick='mostrarOOcultar($linea[idcategoria]);cambiarImagen(this);'></img>".$numeroDeHijosQuetieneHijosEstaCategoria."</li>";
								else echo "<li>|__ <a href=categoria/$linea[idcategoria]>".$linea['nombrecategoria']."</a><img src='http://www.gestorwebs.tipolisto.es/imagenes/mas.png' onclick='mostrarOOcultar($linea[idcategoria]);cambiarImagen(this);'></img>".$numeroDeHijosQuetieneHijosEstaCategoria."</li>";
